...
interface NotificationRepository {
    ...
    suspend fun cancelFcmDeviceTokenRegistration(deviceToken: String): Result<Unit>
    ...
    suspend fun fetchNotificationTopicStatus(deviceToken: String): Result<NotificationTopicStatusModel>
