...
internal fun GetAppliedRemainsOptionResponse.toModel() =
    AppliedRemainsOptionModel(
        id = this.id,
        title = this.title,
    )

internal fun GetRemainsApplicationTimeResponse.toModel() =
    RemainsApplicationTimeModel(
...
private fun GetRemainsOptionsResponse.RemainsOption.toModel() =
    RemainsOptionModel(
        id = this.id,
        title = this.title,
